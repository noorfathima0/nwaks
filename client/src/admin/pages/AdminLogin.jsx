    ...
    <div className="min-h-screen flex items-center justify-center bg-background">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-charcoal">Admin Login</h2>
          <p className="text-gray-500 text-sm mt-1">Welcome back! Please sign in</p>
        </div>

        {/* Form */}
        <form onSubmit={handleLogin} className="bg-white p-8 rounded-xl shadow-lg border border-gray-100">
